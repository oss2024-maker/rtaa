...
class ResNetSE(nn.Module):
    ...
    def __init__(self, block, layer, num_filters, n_out, encoder_type='SAP', n_mels=40, log_input=True, **kwargs):
        ...
        self.layer1 = self._make_layer(block, num_filters[0], layer[0])
        self.layer2 = self._make_layer(block, num_filters[1], layer[1], stride=(2, 2))
        self.layer3 = self._make_layer(block, num_filters[2], layer[2], stride=(2, 2))
        self.layer4 = self._make_layer(block, num_filters[3], layer[3], stride=(1, 1))
